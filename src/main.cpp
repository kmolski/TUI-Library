...
{
    auto grid =
      std::make_shared<Grid>(Position{ 1, 1 },
                             Size{ 1, 1 },
    ...
    auto list = std::make_shared<List>(Position{ 1, 1 },
                                       Size{ 1, 1 },
                                       Color{ Color::Foreground::Default, Color::Background::Blue },
                                       Direction::Vertical);

    auto b1 = std::make_shared<Button>(Position{ 1, 1 },
                                       Size{ 5, 20 },
                                       Color{ Color::Foreground::Brown, Color::Background::Cyan },
                                       "Sample text");

    auto b2 = std::make_shared<Button>(Position{ 1, 1 },
                                       Size{ 5, 20 },
                                       Color{ Color::Foreground::Blue, Color::Background::Black },
                                       "Sample text");

    auto b3 = std::make_shared<Button>(Position{ 1, 1 },
                                       Size{ 5, 20 },
    ...
    auto split = std::make_shared<Split>(
      Position{ 1, 1 }, Size{ 1, 1 }, Direction::Horizontal, 0.75, grid, list);

    auto w1 = std::make_shared<Window>(Position{ 1, 1 },
                                       Size{ 30, 60 },
                                       Color{ Color::Foreground::Blue, Color::Background::Black },
                                       "Window 1");
