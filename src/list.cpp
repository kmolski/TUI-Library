...
List::List(Position _pos, Size _size, Color _color, Direction _dir)
...
void
List::attach(const std::shared_ptr<Widget>& new_child)
{
...
void
List::attach(const std::vector<std::shared_ptr<Widget>>& new_children)
{
    std::for_each(
