...
Grid::Grid(Position _pos, Size _size, Color _color, Size _grid, Size _elem)
...
void
Grid::attach(const std::shared_ptr<Widget>& new_child)
{
...
void
Grid::attach(const std::vector<std::shared_ptr<Widget>>& new_children)
{
    std::for_each(
...
void
Grid::attach_x_y(const std::shared_ptr<Widget>& new_child, size_t x, size_t y)
{
